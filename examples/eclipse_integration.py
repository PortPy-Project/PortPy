...
'''2) 
Importing the PortPy plan into the Eclipse system
...
# The function above stores the optimal fluence for each beam in a text file that can be imported into the Eclipse system. Please follow these steps to proceed:
# 1- Import the patient's data into the Eclipse system (this includes CT images and RT structures).
#
