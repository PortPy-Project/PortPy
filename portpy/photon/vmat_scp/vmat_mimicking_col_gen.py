...
class VmatMimickingColGen(Optimization):
    ...
    def calculate_scores_grad_new(self, A, A_indices, sol):
        ...
        scores = (ptv_dm_grad + oar_dm_grad + overdose_grad + underdose_grad + quadratic_grad + constraints_grad)
    ...
    def run_col_gen_algo(self, *args, **kwargs):
        ...
        # Start
        self.obj_funcs = self.obj_funcs = [
                                            {'type': 'PTV-dose-mimicking', 'structure_name': 'PTV', 'weight': 100000.0},
                                            {'type': 'OAR-dose-mimicking', 'structure_name': 'OAR', 'weight': 500.0},
                                            {
